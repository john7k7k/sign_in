...
<v-card v-for="(name,index) in 3" :key="name" class="Swiper-item" width="400" height="350" variant="elevated">
  <v-img
  :src="poolsdata[index].imageurl"
  class="align-end"
  width="400"
  height="250"
  cover>
  <div class="text-white  ml-5 text-h5 font-weight-black">3</div>
  <div class="text-white mb-16 ml-5 text-h6 font-weight-black" style="white-space: pre-wrap; width: 60%;"> {{poolsdata[index].Eninstruction}} </div>
  </v-img>
</v-card>
<template>
